 ...
 * @since 2016.04.13.
 */
public class TileViewAccessor implements TweenAccessor<in.dragonbra.view.TileView> {

    public static final int POS_XY = 1;
    public static final int SCALE = 2;

    @Override
    public int getValues(in.dragonbra.view.TileView target, int tweenType, float[] returnValues) {
        switch (tweenType) {
            case POS_XY:
    ...
    @Override
    public void setValues(in.dragonbra.view.TileView target, int tweenType, float[] newValues) {
        switch (tweenType) {
            case POS_XY:
