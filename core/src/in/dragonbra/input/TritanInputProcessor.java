 ...
 * @since 2016. 04. 11.
 */
public class TritanInputProcessor implements InputProcessor {

    private static final String TAG = TritanInputProcessor.class.getSimpleName();

    private Logger logger;

    private TritanInputListener listener;
    ...
    public boolean touchDragged(int screenX, int screenY, int pointer) {
        ...
        if (direction == null) {
            ...
            if (dst > in.dragonbra.Consts.MIN_DRAG_DISTANCE) {
    ...
    public void setListener(TritanInputListener listener) {
    ...
    public void updateAccelerometer() {
        ...
        if (inclination < in.dragonbra.Consts.INCLINATION_LIMIT) {
    ...
    public interface TritanInputListener {
