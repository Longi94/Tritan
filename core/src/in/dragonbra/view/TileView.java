...
import in.dragonbra.shape.EquilateralTriangle;
...
public class TileView implements BaseView {
    ...
    private in.dragonbra.model.Tile tile;
    ...
    public void setTile(in.dragonbra.model.Tile tile) {
        this.tile = tile;
    }
    ...
    public in.dragonbra.model.Tile getTile() {
        return tile;
    }
