...
import in.dragonbra.controller.impl.GameControllerImpl;
import in.dragonbra.input.TritanInputProcessor;
import in.dragonbra.model.impl.GameModelImpl;
import in.dragonbra.renderer.impl.GameRendererImpl;

/**
 * @author longi
 * @since 2016.04.10.
 */
public class TritanGameScreen implements Screen {

    public static final int TEXT_UPDATE_FREQUENCY = 500;

    private static final String TAG = TritanGameScreen.class.getSimpleName();
    ...
    private TritanInputProcessor inputProcessor;

    public TritanGameScreen() {
    ...
    public void show() {
        ...
        inputProcessor = new TritanInputProcessor();
